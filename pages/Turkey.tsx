...
function Turkey({ data1, data2, data3, data4 }: Props) {
...
export const getStaticProps: GetStaticProps<Props> = async () => {
  const prayerDataPromises = [
    fetchPrayerTime("http://muslimsalat.com/%C4%B0stanbul/weekly/23-03-2023/true.json?key=705ad57b02ad96ff58f3ca25bc911a6b"),
    fetchPrayerTime("http://muslimsalat.com/%C4%B0stanbul/weekly/30-03-2023/true.json?key=705ad57b02ad96ff58f3ca25bc911a6b"),
    fetchPrayerTime("http://muslimsalat.com/%C4%B0stanbul/weekly/06-04-2023/true.json?key=705ad57b02ad96ff58f3ca25bc911a6b"),
    fetchPrayerTime("http://muslimsalat.com/%C4%B0stanbul/weekly/13-04-2023/true.json?key=705ad57b02ad96ff58f3ca25bc911a6b"),
  ]
