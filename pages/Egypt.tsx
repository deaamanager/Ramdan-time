...
export const getStaticProps: GetStaticProps<Props> = async () => {
  const prayerDataPromises = [
    fetchPrayerTime(
      "http://muslimsalat.com/cairo/weekly/23-03-2023/true.json?key=705ad57b02ad96ff58f3ca25bc911a6b"
    ),
    fetchPrayerTime(
      "https://muslimsalat.com/cairo/weekly/30-03-2023/true.json?key=705ad57b02ad96ff58f3ca25bc911a6b"
    ),
    fetchPrayerTime(
      "https://muslimsalat.com/cairo/weekly/06-04-2023/true.json?key=705ad57b02ad96ff58f3ca25bc911a6b"
    ),
    fetchPrayerTime(
      "https://muslimsalat.com/cairo/weekly/13-04-2023/true.json?key=705ad57b02ad96ff58f3ca25bc911a6b"
    ),
  ];
